from src.loaders.pdf_loader import load_and_split_pdfs
from langchain_openai import OpenAIEmbeddings
from langchain_community.vectorstores import FAISS, Pinecone, Weaviate
import pinecone, weaviate

# Load your new data file (replace with any fresh PDF you want to use)
pdf_paths = ["data/company_policy.pdf"]
...
pinecone_db = Pinecone.from_documents(docs, embeddings, index_name="policy-index")

# --- Option 3: Weaviate (semantic graph) ---
client = weaviate.Client("https://your-weaviate-instance")
weaviate_db = Weaviate.from_documents(docs, embeddings, client=client, index_name="PolicyDocs")
